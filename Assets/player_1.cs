...
public class player_1 : MonoBehaviour
{
    ...
    {
        RaycastHit2D temp = Physics2D.Raycast(new Vector2(transform.position.x, transform.position.y - GetComponent<BoxCollider2D>().bounds.extents.y - 0.1F), -Vector2.up, 0.1F, 1);
    ...
    void Update()
    {
        ...
        if (ManagerVariables.player == false)
        {
